...
public class PersistentServerConcurrencyTest {
    ...
    @Before
    public void setup() throws GeneralSecurityException, IOException, URISyntaxException {
    ...
    @Test
    public void concurrencyPostTest() throws InterruptedException, GeneralSecurityException, IOException, CommonDomainException {
        ...
        for (int i = 0; i < NUMBER_THREADS; i++) {
            ...
            for (var announcement : impl.getAnnouncements().values()) {
                ...
                assertTrue(announcement.getSeq() <= NUMBER_POSTS);
            }
    ...
    @Test
    public void concurrencyPostGeneralTest() throws InterruptedException, GeneralSecurityException, IOException, CommonDomainException {
        Thread[] threads = new Thread[NUMBER_THREADS];
        for (int i = 0; i < NUMBER_THREADS; i++) {
            final int id = i;
