...
public class ServerDPAS {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 4) {
            ...
            System.err.printf("<Usage> java port saveFile ServerKeyStoreFile ServerPublicKeyFile %s %n", ServerDPAS.class.getName());
            return;
        }
        ...
        try(FileInputStream fis = new FileInputStream(jksFile)) {
            ...
            System.out.println("Error: Could not server client key from KeyStore (Did you input the correct password?)!");
            System.exit(-1);
        }
