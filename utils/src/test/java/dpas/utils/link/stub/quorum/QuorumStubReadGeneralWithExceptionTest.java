...
public class QuorumStubReadGeneralWithExceptionTest {
    ...
    @Test
    public void readGeneralNoExceptionsImmediateReply() throws IOException, InterruptedException, GeneralSecurityException {
        ...
        var reply = qstub.readGeneralWithException(Contract.ReadRequest.newBuilder()
    ...
    public void majorityException() throws IOException, InterruptedException, GeneralSecurityException {
        ...
        try {
            reply = qstub.readGeneralWithException(Contract.ReadRequest.newBuilder()
                    .setPublicKey(ByteString.copyFrom(_pubKey.getEncoded()))
                    .setNumber(3)
                    .build());
    ...
    @Test
    public void readGeneralOneTwoAndThree() throws IOException, InterruptedException, GeneralSecurityException {
